    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-md-4">
        <div class="card-veiculo">
          <img src="../ferrari.jpeg" alt="Ferrari">
      ...
      <div class="col-md-4">
        <div class="card-veiculo">
          <img src="../lamborghini_azul.jpg" alt="lamborghini">
      ...
      <div class="col-md-4">
        <div class="card-veiculo">
          <img src="../bulgatti.jpg" alt="bugatti">
      ...
      <div class="col-md-4">
        <div class="card-veiculo">
          <img src="../maserati.jpg" alt="maserati">
          <h5>Maserati MC20</h5>
      ...
      <div class="col-md-4">
        <div class="card-veiculo">
          <img src="../porshe_rosa.jpg" alt="Porsche Rosa">
