...
<div class="car-section">
    ...
    <div class="car-image-wrapper">
        <img src="../porshe.png" alt="Porsche Cinza Fosco" class="car-img">
    </div>
</div>
<div class="car-cards">
  <div class="container">
    <div class="row justify-content-center g-4">
      ...
      <div class="col-md-4">
        <div class="card-veiculo shadow-box">
          <img src="../bmw.jpg" class="img-fluid mb-3 rounded" alt="Carro 1">
      ...
      <div class="col-md-4">
        <div class="card-veiculo shadow-box">
          <img src="../audi.jpg" class="img-fluid mb-3 rounded" alt="Carro 2">
      ...
      <div class="col-md-4">
        <div class="card-veiculo shadow-box">
          <img src="../mercedes.jpg" class="img-fluid mb-3 rounded" alt="Carro 3">
